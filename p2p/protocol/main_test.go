...
// Returns the peer and the private key
func generateTestPeer(t *testing.T, mnet mocknet.Mocknet) (host.Host, crypto.PrivKey) {
...
func signChallenge(t *testing.T, nonce []byte, host host.Host) ([]byte, error) {
